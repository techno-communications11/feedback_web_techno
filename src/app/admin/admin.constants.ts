export const colors = [
    ...
    "linear-gradient(135deg, #fa709a 0%, #fee140 100%)", // Coral to Yellow
  ...
  export const categories = [
      {
        ...
        color: "#cfe2ff",
        icon: "👤",
        fields: ["first_name", "last_name", "ntid","market"],
      },
      {
        title: "Manager Info",
        color: "#d1e7dd",
        icon: "👔",
        fields: ["market_manager_firstname", "market_manager_lastname"],
      },
      {
